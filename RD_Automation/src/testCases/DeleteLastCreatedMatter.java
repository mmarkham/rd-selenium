...
import Main.RootContext;
import Main.WebDriver_Execute;

public class DeleteLastCreatedMatter {
	
	public DeleteLastCreatedMatter() {
	...
	public void WebDriver(WebDriver driver, WebDriverWait wait, String baseUrl) {
		driver.get(baseUrl);
	 	...
	 	// Select quick links
	 	try {
	 		driver.findElement(By.xpath("//div[@id='mattersAccordion']/div/div/div/div/div[4]/div/div[2]/span")).click();
	 	} catch (TimeoutException te){
	 		wait.until( ExpectedConditions.elementToBeClickable(By.xpath("//div[@id='mattersAccordion']/div/div/div/div/div[4]/div/div[2]/span")));
	 		driver.findElement(By.xpath("//div[@id='mattersAccordion']/div/div/div/div/div[4]/div/div[2]/span")).click();
	 	} catch (Exception e) {
	 		WebDriver_Execute.log4j.error("No 'quick links' button element found");
	 		throw(e);
	 	}
